        ...
        <div className='main-container'>
          <section className='announcements'>
            <span>
              ...
              useful. If it's a website to find where to do sports outside, as
              BeActiv that was created during the pandemic. Or a useful
              fullstack application that need authorization in order to get
              access.
